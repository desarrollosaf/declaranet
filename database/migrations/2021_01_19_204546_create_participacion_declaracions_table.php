...
class CreateParticipacionDeclaracionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('participacion_declaraciones', function (Blueprint $table) {
            ...
            $table->foreign("tipo_institucion_id")->references("id")->on("tipo_instituciones");
            ...
            $table->string("primer_apellido_pariente");
            $table->string("segundo_apellido_pariente")->nullable();
            $table->date("fecha_nacimiento_pariente")->nullable();
