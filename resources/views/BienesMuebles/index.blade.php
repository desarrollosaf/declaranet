            ...
            <div class="card-body">
                    ...
                    @else
                        ...
                        <ol type=”A”>
                            ...
                            <li>Aparatos electrónicos y electrodomésticos (PC, tableta electrónica, teléfono celular, televisión, refrigerador, lavadora, etc.)</li>
                            <li>Colecciones (libros, sellos, etc.)</li>
                            <li>Obras de arte</li>
                            <li>Otros (animales, antigüedades, etc.)</li>
                        </ol>

                        Deberá proporcionar la información de CADA UNO de los bienes muebles, que a la fecha de ingreso al cargo sean propiedad del Declarante, así como los de su pareja y/o dependientes económicos.
                        ...
                        <div class="alert alert-danger text-center" role="alert">
                            <label style="margin-top:10px;">
                                ...
                                <strong>Si no tiene bienes muebles, seleccione <a href="{{route('vehiculos.create')}}" class="btn btn-sm btn-secondary">Ninguno</a></strong>
                            </label>
                        </div>
