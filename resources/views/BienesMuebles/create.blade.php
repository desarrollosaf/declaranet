    ...
    <div class="card mb-5 shadow-sm border-0 shadow-hover">
        ...
        <div class="card-header">
            ...
            <div class="float-right">
                <span class="badge badge-success ml-auto px-4" data-toggle="collapse" href="#collapseMuebles" role="button" aria-expanded="false" aria-controls="collapseExample"> AYUDA</span>
            </div>
        </div>
