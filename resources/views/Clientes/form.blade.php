    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <br>
                    <select id="c_principales_actividadLucrativa" name="c_principales_actividadLucrativa" class="form-control" required="" onchange="MostrarContenido();">
    ...
    <div id="contenedores" style="display:none">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" for="NumDoc">Títular de la actividad lucrativa:</label>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" style="line-height : 15px;">Nombre de la empresa o del servicio que proporciona:</label>
                        <input type="text" class="form-control" name="c_principales_n_empresa" id="c_principales_n_empresa" placeholder="p. eje. MAE S.A de C.V" value="">
                    </div>
                </div>

                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" for="NumDoc">RFC:</label>
                        <input type="text" class="form-control" name="c_principales_rfc" id="c_principales_rfc" placeholder="P. EJ. XAXX010101XXX" value="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" for="NumDoc">Tipo de cliente principal:</label>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4" id="otro" style="display: none;">
                    <div class="form-group">
                        <label class="control-label" style="text-align:justify">Especifique:</label>
                        <input type="text" name="otro" id="otro" class="form-control" placeholder="p. ej. Depto. de Informática" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}" title="Ingresa otro" value="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" style="line-height : 13px;">Monto aproximado del beneficio o ganancia mensual que obtiene del cliente principal:</label>
                        <input type="number" class="form-control" name="c_principales_m_aprox" id="c_principales_m_aprox" pattern="[0-9]{10}" title="Ingresa un número entero" required="" placeholder="p. eje. 10,000.00 Mxn" value="">
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <div id="dom_mex" style="display: none;">
                            ...
                            <input class="form-control" id="c_princialesEntidad" name="c_princialesEntidad" required="" type="text" placeholder=" p. ej. México" value="">
                        </div>
                        <!-- EX  --> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea name="c_princialesAclaracionesObservaciones" style="" id="c_princialesAclaracionesObservaciones" cols="62" rows="5" class="form-control"></textarea>
                    </div>
                </div>
            </div>
        </div>
