<div class="card-body">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                {!! Form::select('clientes[actividad_lucrativa]', $selectRespuestas, isset($clientes) ? $clientes->actividad_lucrativa : [],['class'=>'form-control',  'id' => 'actividad_lucrativa']) !!}
            </div>
        </div>
    </div><br>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::text('clientes[nombre_empresa]', isset($clientes) ? $clientes->nombre_empresa : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'nombre_empresa']) !!}
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC:</strong></label>
                    {!! Form::text('clientes[rfc]', isset($clientes) ? $clientes->rfc : null,['class'=>'form-control', 'placeholder'=>'P. ej. 2006',   'id' => 'rfc']) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4" id="fisica">
                    <div class="form-group">
                        ...
                        {!! Form::text('clientes[nombre_cliente]', isset($clientes) ? $clientes->nombre_cliente : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'nombre_cliente']) !!}
                    </div>
            </div>
            <div class="col-lg-4" id="fisica">
                    <div class="form-group">
                        <label class="control-label" for="State"><strong>RFC:</strong></label>
                        {!! Form::text('clientes[rfc_cliente]', isset($clientes) ? $clientes->rfc_cliente : null,['class'=>'form-control', 'placeholder'=>'P. ej. 2006',   'id' => 'rfc_cliente']) !!}
                    </div>
            </div>
            <div class="col-lg-4" id="moral" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('clientes[nombre_cliente_moral]', isset($clientes) ? $clientes->nombre_cliente_moral : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'nombre_cliente_moral']) !!}
                </div>
            </div>
            <div class="col-lg-4" id="moral" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC:</strong></label>
                    {!! Form::text('clientes[rfc_cliente_moral]', isset($clientes) ? $clientes->rfc_cliente_moral : null,['class'=>'form-control', 'placeholder'=>'P. ej. 2006',   'id' => 'rfc_cliente_moral']) !!}
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::text('clientes[sector_especifique]', isset($clientes) ? $clientes->sector_especifique : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'sector_especifique', 'disabled' => 'disabled']) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::text('clientes[monto_beneficio]', isset($clientes) ? $clientes->monto_beneficio : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'monto_beneficio']) !!}
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-4" id="mx">
                <div class="form-group">
                    ...
                    {!! Form::text('clientes[entidad_federativa]', isset($clientes) ? $clientes->entidad_federativa : null,['class'=>'form-control', 'placeholder'=>'P. ej. Clío',   'id' => 'entidad_federativa', 'disabled'=> 'disabled']) !!}
                </div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        $("#actividad_lucrativa").on("change",function(){
            var actividad_lucrativa = document.getElementById("actividad_lucrativa").value
