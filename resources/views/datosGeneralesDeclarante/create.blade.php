    ...
    <div class="card mb-5 shadow-sm border-0 shadow-hover">
        ...
        <div class="collapse" id="collapseDatosEmpleo">
            <div class="card-body">
                ...
                <ol class="ayuda">
                    <li><p align="justify"><strong>Nombre(s), primer y segundo apellidos. </strong>Escribir el nombre o los nombres
                    ...
                    <li><p align="justify"><strong>Clave Única de Registro de Población (CURP).</strong> Escribir los dieciocho
                    ...
                    <li><p align="justify"><strong>Registro Federal de Contribuyentes (RFC) y homoclave.</strong> Escribir los diez
                    ...
                    <li><p align="justify"><strong>Correo electrónico institucional (si aplica).</strong> Escribir la dirección de
                        correo electrónico que le haya sido asignada por el Ente Público en el que
                        labora.
                        </p></li>
                    <li><p align="justify"><strong>Correo electrónico personal/alterno.</strong> Escribir la dirección de correo
                    ...
                    <li><p align="justify"><strong>Número telefónico de casa.</strong> Escribir el número telefónico de su domicilio,
                        incluir lada.
                        </p> </li>
                    <li><p align="justify"><strong>Número celular personal.</strong> Escribir los diez dígitos de su número celular.
                        </p></li>
                    <li><p align="justify"><strong>Situación personal/estado civil.</strong> Es la condición del Declarante en función
                    ...
                    <li><p align="justify"><strong>Régimen matrimonial.</strong> En su caso, especificar: sociedad conyugal, separación
                        de bienes u otro/especifique.
                        </p></li>
                    <li><p align="justify"><strong>País de nacimiento.</strong> De la lista desplegable, el Declarante deberá elegir el
                        país donde nació.
                        </p></li>
                    <li><p align="justify"><strong>Nacionalidad.</strong> De la lista desplegable, el Declarante deberá elegir su
                        nacionalidad.
                        </p></li>
                    <li><p align="justify"><strong>¿Te desempeñaste como servidor público el año inmediato anterior?</strong> Elegir sí
                        o no. (Solo en declaración de modificación).
                        </p></li>
                    <li><p align="justify"><strong>Aclaraciones/observaciones.</strong> En este espacio el Declarante podrá realizar las
