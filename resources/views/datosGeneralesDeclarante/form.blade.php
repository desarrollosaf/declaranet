...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        {!! Form::label('rfc', 'RFC:') !!}
        {!! Form::text('rfc',null,['class'=>'form-control', 'placeholder'=>'',  'id' => 'rfc']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
        {!! Form::label('homoclave', 'Homoclave:') !!}
        {!! Form::text('homoclave',null,['class'=>'form-control', 'placeholder'=>'',  'id' => 'homoclave']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
</div>
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        {!! Form::text('cpersonal',null,['class'=>'form-control', 'placeholder'=>'',  'id' => 'cpersonal']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
        {!! Form::label('telcasa', 'Número telefónico de casa:') !!}
        {!! Form::text('telcasa',null,['class'=>'form-control', 'placeholder'=>'',  'id' => 'telcasa']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
</div>
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        {!! Form::text('celpersonal',null,['class'=>'form-control text-uppercase', 'placeholder'=>'',  'id' => 'celpersonal']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        {!! Form::text('pnacimiento',null,['class'=>'form-control text-uppercase', 'placeholder'=>'',  'id' => 'pnacimiento']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-6">
        {!! Form::label('nacionalidad', 'Nacionalidad:') !!}
        {!! Form::text('nacionalidad',null,['class'=>'form-control', 'placeholder'=>'',  'id' => 'nacionalidad']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
</div>
<div class="form-row">
