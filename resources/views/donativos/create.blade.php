    ...
    <div class="card mb-5 shadow-sm border-0 shadow-hover">
        ...
        <div class="collapse" id="collapseExample">
            <div class="card-body">
                ...
                <ol>
                    <li> <strong>Deberá declarar los donativos realizados por el declarante, cónyuge, concubina,concubinario, familiares hasta en segundo grado y/o dependientes económicos, así como los que hubieran realizado a fundaciones u organizaciones no lucrativa de las que forma parte el declarante.</strong></li>
                    <br>
