    ...
    <div class="col-md-2"> 
        <table>
            <tr>
                ...
                <td align='left'>{!! Form::text('ingresoMensual[ingreso_por_actividad_ice]',(isset($ingresoMensual->ingreso_por_actividad_ice)) ? $ingresoMensual->ingreso_por_actividad_ice : null,['class'=>'form-control text-uppercase',  'id' => 'ingreso_por_actividad_ice']) !!}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-1"></div>
    ...
    <div class="col-md-2"> 
        <table>
            <tr>
                ...
                <td align='left'>{!! Form::text('ingresoMensual[ingreso_por_actividad_financiera]',(isset($ingresoMensual->ingreso_por_actividad_financiera)) ? $ingresoMensual->ingreso_por_actividad_financiera : null,['class'=>'form-control text-uppercase',  'id' => 'ingreso_por_actividad_financiera']) !!}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-1"></div>
    ...
    <div class="col-md-2"> 
        <table>
            <tr>
                ...
                <td align='left'>{!! Form::text('ingresoMensual[ingreso_por_servicios_profesionales]',(isset($ingresoMensual->ingreso_por_servicios_profesionales)) ? $ingresoMensual->ingreso_por_servicios_profesionales : null,['class'=>'form-control text-uppercase',  'id' => 'ingreso_por_servicios_profesionales']) !!}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-1"></div>
    ...
    <div class="col-md-2"> 
        <table>
            <tr>
                ...
                <td align='left'>{!! Form::text('ingresoMensual[ingreso_otros]',(isset($ingresoMensual->ingreso_otros)) ? $ingresoMensual->ingreso_otros : null,['class'=>'form-control text-uppercase',  'id' => 'ingreso_otros']) !!}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-1"></div>
    ...
    <div class="col-md-2"> 
        <table>
            <tr>
                ...
                <td align='left'>{!! Form::text('ingresoMensual[ingreso_mensual_neto_pareja]',(isset($ingresoMensual->ingreso_mensual_neto_pareja)) ? $ingresoMensual->ingreso_mensual_neto_pareja : null,['class'=>'form-control text-uppercase',  'id' => 'ingreso_mensual_neto_pareja']) !!}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-10">
    ...
    <div class="col-md-2"> 
      ...
      <div class="form-group col-md-12">
          <h6>ACLARACIONES/OBSERVACIONES:</h6>
                    {!! Form::textarea('ingresoMensual[aclaraciones_observaciones]',(isset($ingresoMensual->aclaraciones_observaciones)) ? $ingresoMensual->aclaraciones_observaciones : null,['class'=>'form-control text-uppercase',  'id' => 'aclaraciones_observaciones']) !!}
