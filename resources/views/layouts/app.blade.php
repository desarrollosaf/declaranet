...
<div class="d-flex" id="content-wrapper">
    ...
    <div id="sidebar-container" class="bg-light border-right">
        ...
        <div class="menu list-group-flush">
            ...
            <a href="{{route('datos_dependiente_declarante.index')}}" class="nav-tabs nav-link text-light ml-4 mr-3"><i class="ion ion-person-add mr-2"></i>Datos de los dependientes</a>
