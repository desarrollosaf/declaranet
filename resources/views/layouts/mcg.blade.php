            ...
            <ul class="navbar-nav align-self-stretch">
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample2" role="button"
                       data-toggle="collapse">
                        <strong>Padrón de obligados</strong>
                    </a>
                                                ...
                                                <div class="menu list-group-flush">
                                                    <a href="{{route('datos_declarante.create')}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i> Detección de omisos y no obligados</a>
                                                    <a href="{{route('domicilio_declarante.index')}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i>Consultar situación del Padrón</a>
                                                    <a href="{{route('datos_curriculares_declarante.index')}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i>Consultar situación del Servidor Público</a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample3" role="button"
                       data-toggle="collapse">
                        <strong>Detección de omisos</strong>
                    </a>
                                        ...
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <div class="menu list-group-flush">
                                                    ...
                                                    <a href="{{route("participacion.index")}}"
                                                        class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            lass=""></i> Consultar situación del Servidor Público</a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample4" role="button"
                       data-toggle="collapse">
                        <strong>Administración de servidores<br>públicos autorizados</strong>
                    </a>
                                        ...
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <div class="menu list-group-flush">
                                                    <a href="{{route("participacion_empresas.index")}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i>Registro de usuarios</a>
                                                    <a href="{{route("participacion.index")}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i> Catálogo de solicitantes de cambios</a>
                                                    <a href="{{route("participacion.index")}}"
                                                        class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            lass=""></i>Modificar/Eliminar datos a los movimientos</a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample5" role="button"
                       data-toggle="collapse">
                        <strong>Consulta de datos de ingreso<br>al Declaranet Legis</strong>
                    </a>
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample6" role="button"
                       data-toggle="collapse">
                        <strong>Informes de uso del<br>Módulo de Control de Gestión</strong>
                    </a>
                                        ...
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <div class="menu list-group-flush">
                                                    <a href="{{route("participacion_empresas.index")}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i> Consulta de modificación a los datos los datos de los movimientos</a>
                                                    <a href="{{route("participacion_empresas.index")}}"
                                                        class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i>Cambio de estado (en término a omiso)</a>
                                                    <a href="{{route("participacion_empresas.index")}}"
                                                        class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i>Consulta de edición a los datos del servidor público</a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample7" role="button"
                       data-toggle="collapse">
                ...
                <li class="has-sub">
                    <a class="nav-link collapsed text-left" href="#collapseExample8" role="button"
                       data-toggle="collapse">
                        <strong>Actualizacion Declaración de Intereses</strong>
                    </a>
                                        ...
                                        <div class="submenu-box">
                                            <ul class="list-unstyled m-0">
                                                <div class="menu list-group-flush">
                                                    <a href="{{route("participacion_empresas.index")}}"
                                                       class="nav-tabs nav-link text-light ml-4 mr-3"><i
                                                            class=""></i> Actualización de Servidores Públicos</a>
                                                </div>
                                            </ul>
                                        </div>
                                    </div>
