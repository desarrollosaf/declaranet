    ...
    <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" for="ProcessNum"><strong>Tìtular vehículo: *</strong></label>
        ...
        <div id="difDec">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <div id="terceroNombreFisica" style="display: block;">
                                <label class="control-label" for="NumDoc"><strong>Nombre del trasmisor de la propiedad: *</strong></label>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="control-label" for="NumDoc"><strong>Especifique otro tipo de relación con el transmisor: *</strong></label>
