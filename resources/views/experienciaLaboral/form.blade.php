...
<div class="row">
    ...
    <div class="form-group col-md-4 AMBOS">
        ...
        {!! Form::select('experiencia[lugares_ubicacion]',$ubicacion,isset($experiencia) ? $experiencia->lugares_ubicacion : null,['class'=>'form-control text-uppercase','id' => 'lugares_ubicacion','placeholder' => 'Selecciona una opción', 'required' => 'true']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
</div>
<div class="row">
