<div class="row">
    ...
    <div class="form-group col-md-5">
        {!! Form::select('experiencia[ambito_sector_id]', $ambitos_sectores, isset($experiencia) ? $experiencia->ambito_sector_id : null,['class'=>'form-control text-uppercase','id' => 'ambito_sector_id','placeholder' => 'Selecciona una opción']) !!}
    </div>
</div>
<div class="row">
    ...
    <div class="form-group col-md-4 PÚBLICO">
        ...
        {!! Form::select('experiencia[nivel_orden_gobierno_id]', $nivelOrdenGobierno,isset($experiencia) ? $experiencia->nivel_orden_gobierno_id : [],['class'=>'form-control text-uppercase','id' => 'nivel_orden_gobierno_id','placeholder' => 'Selecciona una opción']) !!}
    </div>
    <div class="form-group col-md-4 PRIVADO">
    ...
    <div class="form-group col-md-4 PÚBLICO">
        ...
        {!! Form::select('experiencia[ambito_publico_id]',$ambito,isset($experiencia) ? $experiencia->ambito_publico_id : [], ['class'=>'form-control text-uppercase','id' => 'ambito_publico_id' ,'placeholder' => 'Selecciona una opción']) !!}
    </div>
    <div class="form-group col-md-4 PRIVADO">
    ...
    <div class="form-group col-md-4 PRIVADO">
        ...
        {!! Form::select('experiencia[sector_id]',$sectores,isset($experiencia) ? $experiencia->sector_id : null, ['class'=>'form-control text-uppercase','id' => 'sector_id','placeholder' => 'Selecciona una opción']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4 PÚBLICO">
    ...
    <div class="form-group col-md-4 AMBOS">
        ...
        {!! Form::select('experiencia[lugares_ubicacion]',$ubicacion,isset($experiencia) ? $experiencia->lugares_ubicacion : null,['class'=>'form-control text-uppercase','id' => 'lugares_ubicacion','placeholder' => 'Selecciona una opción']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
</div>
<div class="row">
