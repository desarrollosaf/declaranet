    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('bienesinmuebles[tipo_inmueble_id]', isset($selecttipoInmueble) ? $selecttipoInmueble : [], isset($bien) ? $bien->tipo_inmueble_id : null,['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'tipo_inmueble_id']) !!}
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('bienesinmuebles[titular_id]', isset($selecttitularInmueble) ? $selecttitularInmueble : [], isset($bien) ? $bien -> titular_id : null,['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'titular_id']) !!}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('bienesinmuebles[tipo_tercero_id]', isset($selectRegimenFiscal) ? $selectRegimenFiscal : [], isset($bien) ? $bien->tipo_tercero_id : null, ['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'tipo_tercero_id']) !!}
            </div>
        </div>
        ...
        <div class="col-md-4 tercero_fisica">
            <div class="form-group ">
                ...
                {!! Form::text('bienesinmuebles[rfc_tercero_fisica]', isset($bien) ? $bien->rfc_tercero : null, ['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Hacienda',  'id' => 'rfc_tercero_fisica']) !!}
            </div>
        </div>
        ...
        <div class="col-md-4 tercero_moral">
            <div class="form-group ">
                ...
                {!! Form::text('bienesinmuebles[rfc_tercero_moral]', isset($bien) ? $bien->rfc_tercero : null, ['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Hacienda',  'id' => 'rfc_tercero_moral']) !!}
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::text('bienesinmuebles[porcentaje_propiedad]', isset($bien) ? $bien->porcentaje_propiedad : null, ['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 10%',  'id' => 'porcentaje_propiedad']) !!}
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <strong>{!! Form::label('superficieTerreno', ' Superficie del terreno: *') !!}</strong>
                {!! Form::text('bienesinmuebles[superficie_terreno]', isset($bien) ? $bien->superficie_terreno : null, ['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 30m',  'id' => 'superficie_terreno']) !!}
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <strong>{!! Form::label('superficie_construccion', ' Superficie de construcción: * ') !!}</strong>
                {!! Form::text('bienesinmuebles[superficie_construccion]', isset($bien) ? $bien->superficie_construccion : null, ['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 30m',  'id' => 'superficie_construccion']) !!}
            </div>
        </div>
    </div>
</div>
<div class="container">
    <div class="row">
        <div class="col-md-4">
            ...
            {!! Form::select('bienesinmuebles[forma_adquisicion_id]', isset($selectformaAdquisicion) ? $selectformaAdquisicion : [], isset($bien) ? $bien->forma_adquisicion_id : null,['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'forma_adquisicion_id']) !!}
        </div>
        <div class="col-md-4">
            <strong>{!! Form::label('forma_pago_id', ' Forma de pago: *') !!}</strong>
            {!! Form::select('bienesinmuebles[forma_pago_id]', isset($selectformaPago) ? $selectformaPago : [], isset($bien) ? $bien->forma_pago_id : null, ['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'forma_pago_id']) !!}
        </div>
        <div class="col-md-4">
            <div class="form-group">
            </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('bienesinmuebles[tipo_transmisor_id]', isset($selectRegimenFiscal) ? $selectRegimenFiscal : [], isset($bien) ? $bien->tipo_transmisor_id : null,['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'tipo_transmisor_id']) !!}
            </div>
        </div>
        <div class="col-md-4 nombre-Ftransmisor">
            <div class="form-group">
                <strong>{!! Form::label('nombreTransmisorF', ' Nombre del transmisor: * ') !!}</strong>
                {!! Form::text('bienesinmuebles[nombreTransmisorF]', isset($bien) ? $bien->nombre_razon_transmisor : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Juan Robles Rosas',  'id' => 'nombre_TransmisorF']) !!}
            </div>
        </div>
        <div class="col-md-4 rfc-Ftransmisor">
            <div class="form-group">
                <strong>{!! Form::label('rfcTransmisorF', ' RFC del transmisor: * ') !!}</strong>
                {!! Form::text('bienesinmuebles[rfcTransmisorF]', isset($bien) ? $bien->rfc_transmisor : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. XXXX010101XXX', 'maxlength'=>'13', 'id' => 'rfc_TransmisorF']) !!}
        ...
        <div class="col-md-4 nombre-Mtransmisor">
            <div class="form-group">
                ...
                {!! Form::text('bienesinmuebles[nombreTransmisorM]', isset($bien) ? $bien->nombre_razon_transmisor : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Empresa S.A. de C.V.',  'id' => 'nombre_TransmisorM']) !!}
            </div>
        </div>
        <div class="col-md-4 rfc-Mtransmisor">
            <div class="form-group">
                <strong>{!! Form::label('rfcTransmisorM', ' RFC del transmisor: *') !!}</strong>
                {!! Form::text('bienesinmuebles[rfcTransmisorM]', isset($bien) ? $bien->rfc_transmisor : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. XXXX010101XX', 'maxlength'=>'12', 'id' => 'rfc_TransmisorM']) !!}
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('bienesinmuebles[relacion_transmisor_id]', isset($selectRelacionTransmisor) ? $selectRelacionTransmisor : [], isset($bien) ? $bien->relacion_transmisor_id : null,['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'relacion_transmisor_id']) !!}
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::text('bienesinmuebles[valor_adquisicion]', isset($bien) ? $bien->valor_adquisicion : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 100000.0 Mxn', 'id' => 'valor_adquisicion']) !!}
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <strong>{!! Form::label('valor_conforme_id', ' El valor es conforme a: *') !!}</strong>
                {!! Form::select('bienesinmuebles[valor_conforme_id]', isset($selectvalorConforme) ? $selectvalorConforme : [], isset($bien) ? $bien->valor_conforme_id : null, ['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'valor_conforme_id']) !!}
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::text('bienesinmuebles[tipo_moneda]', isset($bien) ? $bien->tipo_moneda : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Peso mexicano', 'id' => 'tipo_moneda']) !!}
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::date('bienesinmuebles[fecha_adquisicion]', isset($bien) ? $bien->fecha_adquisicion : null,['class'=>'form-control text-uppercase  tipo-titular', 'id' => 'fecha_adquisicion']) !!}
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::text('bienesinmuebles[datos_registro]', isset($bien) ? $bien->datos_registro : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 10101010', 'id' => 'datos_registro']) !!}
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            ...
            {!! Form::select('bienesinmuebles[ubicacion_inmueble_id]', isset($selectubicacionInmueble) ? $selectubicacionInmueble : [], isset($bien) ? $bien->ubicacion_inmueble_id : null, ['class'=>'form-control text-uppercase  tipo-titular',  'id' => 'ubicacion_inmueble_id']) !!}
        </div>
        <div class="col-md-8">
            <div class="form-group">
            </div>
...
<div class="container domicilio-MXBinmuebles">
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            {!! Form::text('domicilio[calle]',isset($domicilio) ? $domicilio->calle : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Av. Independencia',  'id' => 'nombre', 'pattern' =>"[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}", 'title' => "Ingresa la calle" ]) !!}
            <span class="text-danger" style="font-size:150%"></span>
        </div>
        <div class="form-group col-md-4">
            <strong>{!! Form::label('exterior', 'Número exterior: *') !!}</strong>
            {!! Form::number('domicilio[num_ext]',isset($domicilio) ? $domicilio->num_ext : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p.ej. 102',  'id' => 'exterior', 'pattern' => "[0-9]{1-5}", 'title' => "Ingresa número exterior"]) !!}
            <span class="text-danger" style="font-size:150%"></span>
        </div>
        <div class="form-group col-md-4">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            {!! Form::text('domicilio[entidad]',isset($domicilio) ? $domicilio->entidad : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. CDMX',  'id' => 'entidad_federativa']) !!}
            <span class="text-danger" style="font-size:150%"></span>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            {!! Form::text('domicilio[codigo_postal]',isset($domicilio) ? $domicilio->codigo_postal : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. 50000',  'id' => 'cp', 'pattern' => "[0-9]{5}", 'title' => "Ingresa código postal a 5 dígitos"]) !!}
            <span class="text-danger" style="font-size:150%"></span>
        </div>
    </div>
</div>
...
<div class="container domicilio-EXBinmuebles">
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            {!! Form::text('domicilio[calleExt]',isset($domicilio) ? $domicilio->calle : null,['class'=>'form-control text-uppercase  tipo-titular', 'placeholder'=>'p. ej. Av. Independencia',  'id' => 'nombre', 'title' => "Ingresa la calle" ]) !!}
            <span class="text-danger" style="font-size:150%"></span>
        </div>
        <div class="form-group col-md-4">
