    ...
    <div id="contenedores" style="display:none;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" style="line-height : 15px;"><strong>Nombre de la empresa o del servicio que proporciona:</strong></label>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label" style="line-height : 13px;"><strong>Monto aproximado del beneficio o ganancia mensual que obtiene del cliente principal:</strong></label>
