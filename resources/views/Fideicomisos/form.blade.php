        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[tipo_relaciones_id]', $participacion, isset($fideicomisos) ? $fideicomisos->tipo_relaciones_id : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_relaciones_id', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="ProcessNum"><strong>Tipo de fideicomiso: *</strong></label>
                    {!! Form::select('fideicomisos[tipo_fideicomisos_id]', $fideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_fideicomisos_id : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_fideicomisos_id', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>Tipo de participación: *</strong></label>
                    {!! Form::select('fideicomisos[tipo_participacion_fideicomisos_id]', $tipoPfideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_participacion_fideicomisos_id : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_participacion_fideicomisos_id', 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[tipo_persona_fideicomiso]', $tipoPersonaFideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_persona_fideicomiso : [],['class'=>'form-control text-uppercase' ,  'id' => 'tipo_persona_fideicomiso', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_fideicomisoN">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_persona_fisica]', isset($fideicomisos) ? $fideicomisos->nombre_persona_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. JUAN HERNANDEZ.',   'id' => 'nombre_persona_fisica', 'disabled'=>true , 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_fideicomisoR">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[rfc_persona_fisica]', isset($fideicomisos) ? $fideicomisos->rfc_persona_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_persona_fisica', 'disabled'=>true, 'size'=>'13', 'maxlength'=>"13", 'pattern' => "([A-Z]{4}[0-9]{6}[A-Z0-9]{0,3})", 'title' => "Ingresa RFC a 10 o 13 dígitos", 'required' => true]) !!}
                </div>
            </div>
            ...
            <div class="col-lg-4" id="moral_fideicomisoN" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_persona_moral]', isset($fideicomisos) ? $fideicomisos->nombre_persona_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. MAE S.A. de C.V.',   'id' => 'nombre_persona_moral', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="moral_fideicomisoR" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[rfc_persona_moral]', isset($fideicomisos) ? $fideicomisos->rfc_persona_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_persona_moral', 'disabled'=>true, 'size'=>'12', 'maxlength'=>"12", 'pattern' => "([A-Z]{3}[0-9]{6}[A-Z0-9]{3})", 'title' => "Ingresa RFC a 12 dígitos", 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[tipo_persona_fideicomitente]', $tipoPersonaFideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_persona_fideicomitente : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_persona_fideicomitente', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_FideicomitenteN">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fideicomitente_fisica]', isset($fideicomisos) ? $fideicomisos->nombre_fideicomitente_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. JUAN PÉREZ',   'id' => 'nombre_fideicomitente_fisica', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            ...
            <div class="col-lg-4" id="moral_FideicomitenteN" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fideicomitente_moral]', isset($fideicomisos) ? $fideicomisos->nombre_fideicomitente_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. MAE S.A. de C.V.',   'id' => 'nombre_fideicomitente_moral', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="moral_FideicomitenteR" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC del fideicomitente: *</strong></label>
                    {!! Form::text('fideicomisos[rfc_fideicomitente_moral]', isset($fideicomisos) ? $fideicomisos->rfc_fideicomitente_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_fideicomitente_moral', 'disabled'=>true, 'size'=>'12', 'maxlength'=>"12", 'pattern' => "([A-Z]{3}[0-9]{6}[A-Z0-9]{3})", 'title' => "Ingresa RFC a 12 dígitos", 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[tipo_persona_fiduciario]', $tipoPersonaFideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_persona_fiduciario : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_persona_fiduciario', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_FiduciarioN">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fiduciario_fisica]', isset($fideicomisos) ? $fideicomisos->nombre_fiduciario_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. JUAN PÉREZ',   'id' => 'nombre_fiduciario_fisica','disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_FiduciarioR">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC del fiduciario: *</strong></label>
                    {!! Form::text('fideicomisos[rfc_fiduciario_fisica]', isset($fideicomisos) ? $fideicomisos->rfc_fiduciario_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_fiduciario_fisica','disabled'=>true, 'size'=>'13', 'maxlength'=>"13", 'pattern' => "([A-Z]{4}[0-9]{6}[A-Z0-9]{0,3})", 'title' => "Ingresa RFC a 10 o 13 dígitos", 'required' => true]) !!}
                </div>
            </div>
            ...
            <div class="col-lg-4" id="moral_FiduciarioN" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fiduciario_moral]', isset($fideicomisos) ? $fideicomisos->nombre_fiduciario_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. MAE S.A. de C.V.',   'id' => 'nombre_fiduciario_moral','disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="moral_FiduciarioR" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC del fiduciario: *</strong></label>
                    {!! Form::text('fideicomisos[rfc_fiduciario_moral]', isset($fideicomisos) ? $fideicomisos->rfc_fiduciario_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_fiduciario_moral','disabled'=>true, 'size'=>'12', 'maxlength'=>"12", 'pattern' => "([A-Z]{3}[0-9]{6}[A-Z0-9]{3})", 'title' => "Ingresa RFC a 12 dígitos", 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[tipo_persona_fideicomisario]', $tipoPersonaFideicomiso, isset($fideicomisos) ? $fideicomisos->tipo_persona_fideicomisario : [],['class'=>'form-control text-uppercase',  'id' => 'tipo_persona_fideicomisario', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_FideicomisarioN">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fideicomisario_fisica]', isset($fideicomisos) ? $fideicomisos->nombre_fideicomisario_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. JUAN PÉREZ',   'id' => 'nombre_fideicomisario_fisica', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="fisica_FideicomisarioR">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[rfc_fideicomisario_fisica]', isset($fideicomisos) ? $fideicomisos->rfc_fideicomisario_fisica : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAXA010101XAX',   'id' => 'rfc_fideicomisario_fisica', 'disabled'=>true, 'size'=>'13', 'maxlength'=>"13", 'pattern' => "([A-Z]{4}[0-9]{6}[A-Z0-9]{0,3})", 'title' => "Ingresa RFC a 10 o 13 dígitos", 'required' => true]) !!}
                </div>
            </div>
            ...
            <div class="col-lg-4" id="moral_FideicomisarioN" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[nombre_fideicomisario_moral]', isset($fideicomisos) ? $fideicomisos->nombre_fideicomisario_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. MAE S.A. de C.V.',   'id' => 'nombre_fideicomisario_moral', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="moral_FideicomisarioR" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>RFC del fideicomisario: *</strong></label>
                    {!! Form::text('fideicomisos[rfc_fideicomisario_moral]', isset($fideicomisos) ? $fideicomisos->rfc_fideicomisario_moral : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. XAX010101XAX',   'id' => 'rfc_fideicomisario_moral', 'disabled'=>true, 'size'=>'12', 'maxlength'=>"12", 'pattern' => "([A-Z]{3}[0-9]{6}[A-Z0-9]{3})", 'title' => "Ingresa RFC a 12 dígitos", 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[sectores_id]', $sector, isset($fideicomisos) ? $fideicomisos->sectores_id : [],['class'=>'form-control text-uppercase',  'id' => 'sectores_id', 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="ProcessNum"><strong>Especifique: *</strong></label>
                    {!! Form::text('fideicomisos[especifique_sector]', isset($fideicomisos) ? $fideicomisos->especifique_sector : null,['class'=>'form-control text-uppercase', 'placeholder'=>'P. EJ. SECTOR PETROLERO',   'id' => 'especifique_sector', 'disabled' => 'disabled', 'required' => true]) !!}
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[lugares_ubicacion_id]', $lugar, isset($fideicomisos) ? $fideicomisos->lugares_ubicacion_id : [],['class'=>'form-control text-uppercase',  'id' => 'lugares_ubicacion_id', 'required' => true]) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4" id="mx">
                <div class="form-group">
                    ...
                    {!! Form::select('fideicomisos[entidades_id]', $entidad, isset($fideicomisos) ? $fideicomisos->entidades_id : [],['class'=>'form-control text-uppercase',  'id' => 'entidades_id', 'placeholder' => 'SELECCIONA UNA OPCIÓN', 'disabled'=>true, 'required' => true]) !!}
                </div>
            </div>
            <div class="col-lg-4" id="ex" style="display: none;">
                <div class="form-group">
                    ...
                    {!! Form::text('fideicomisos[pais]', isset($fideicomisos) ? $fideicomisos->pais : null,['class'=>'form-control text-uppercase',  'id' => 'pais', 'required' => true, 'placeholder'=>'P. EJ. Estados Unidos']) !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    {!! Form::textarea('fideicomisos[aclaraciones]', isset($fideicomisos) ? $fideicomisos->aclaraciones : null,['class'=>'form-control alert-danger text-uppercase',  'id' => 'aclaraciones']) !!}
