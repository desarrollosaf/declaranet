        ...
        <div class="card mb-5 shadow-sm border-0 shadow-hover">
            ...
            <div class="collapse" id="collapseServidor">
                <div class="card-body">
                    ...
                    Únicamente aplica para la declaración de inicio y conclusión y no para la de modificación, en razón
                    de que esta última refiere la situación del año inmediato anterior.
                    ...
                    <ol class="ayuda">
                        ...
                        <li>Remuneración neta del Declarante, recibida durante el tiempo en el que se desempeñó como
                            servidor público en el año inmediato anterior. (Por conceptos de sueldos, honorarios,
                            compensaciones, bonos, aguinaldos y otras prestaciones). (Cantidades netas después de
                            impuestos). Declarar el monto neto que obtuvo durante el tiempo que se desempeñó como
                            servidor público el año inmediato anterior. Este monto deberá incluir sueldo, honorarios,
                            compensaciones, bonos, aguinaldos y otras prestaciones.
                        </li>
                        <li>Otros ingresos del Declarante recibidos durante el año inmediato anterior. Este rubro se
                            llena automáticamente.
                        </li>
                        <li>Por actividad industrial, comercial y/o empresarial (después de impuestos). Señalar el
                            monto neto recibido durante el año inmediato anterior, por alguna o algunas de las
                            actividades descritas.
                        </li>
                        <li>Nombre o razón social. Proporcionar el nombre, razón social o denominación del negocio, en
                            el cual se lleva a cabo la actividad o alguna de las actividades antes mencionadas por la
                        ...
                        <li>Por actividad financiera (rendimientos o ganancias) (después de impuestos). Señalar el
                            monto neto recibido durante el año inmediato anterior, de los rendimientos o ganancias que
                            en su caso se hayan generado por su actividad financiera.
                        </li>
                        <li>Tipo de instrumento que generó el rendimiento o ganancia. Seleccionar el instrumento que
                            ...
                            organizaciones privadas, seguro de separación individualizado, valores bursátiles, bonos y/u
                            otros (especifique).
                        </li>
