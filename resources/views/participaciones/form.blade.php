<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        {!! Form::text('participacion[frecuencia_anual]',isset($participacion) ? $participacion->Frecuencia_anual: null,['class'=>'form-control text-uppercase', 'placeholder'=>'',  'id' => 'nombre','pattern'=>"[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"]) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        ...
        {!! Form::text('participacion[nombre_pariente]',isset($participacion) ? $participacion->nombre_pariente : null,['class'=>'form-control alert-danger text-uppercase', 'placeholder'=>'P.EJ.CARLOS',  'id' => 'nombre','pattern'=>"[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"]) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
        <strong>{!! Form::label('participacion[primer_apellido]', 'Primer apellido: *') !!}</strong>
        {!! Form::text('participacion[primer_apellido_pariente]',isset($participacion) ? $participacion->primer_apellido_pariente : null,['class'=>'form-control alert-danger text-uppercase', 'placeholder'=>'',  'id' => 'nombre','pattern'=>"[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"]) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
        <strong>{!! Form::label('participacion[segundo_apellido]', 'Segundo apellido:') !!}</strong>
        {!! Form::text('participacion[segundo_apellido_pariente]',isset($participacion) ? $participacion->segundo_apellido_pariente : null,['class'=>'form-control alert-danger text-uppercase', 'placeholder'=>'',  'id' => 'nacimiento','required'=> true,'max' => date('Y-m-d')]) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
        <strong>{!! Form::label('participacion[fecha de nacimiento]', 'Fecha de nacimiento:') !!}</strong>
    ...
    <div class="form-group col-md-4">
        <strong>{!! Form::label('participacion[RFC]', 'RFC:') !!}</strong>
        {!! Form::text('participacion[rfc_pariente]',isset($participacion) ? $participacion->rfc_pariente : null,['class'=>'form-control alert-danger text-uppercase', 'placeholder'=>'p. ej. XAXX010101XXX',  'id' => 'rfc','pattern'=>'([A-ZÑ&]{4}\d{6}[A-Z\d]{3})']) !!}
        <span class="text-danger" style="font-size:150%"></span>
    </div>
    <div class="form-group col-md-4">
