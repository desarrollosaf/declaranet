<div class="card-body">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="NumDoc"><strong>Titular de la representación:</strong></label>
            ...
            <div class="col-lg-4">
                ...
                <label class="control-label" for="ProcessNum"><strong>Tipo de representación:</strong></label><br>
                <select id="representacion_tipo" name="representacion_tipo" class="form-control" required="">
                    <option value="">Seleccione una opción</option>                                                <option value="REPE">REPRESENTANTE</option>
                    <option value="REPED">>REPRESENTADO </option>
                </select>

            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="State"><strong>Fecha de inicio de la representación:</strong></label>
                    <input type="date" placeholder="p.ej. 18/10/2019" class="form-control" name="representacion_fecha" id="representacion_fecha" value="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" for="NumDoc"><strong>Representante / Representado:</strong></label>
            ...
            <div class="col-lg-4" id="terceroFdisabled">
                <div class="form-group">
                    <label class="control-label" style="line-height : 15px;"><strong>Nombre del representante / representado:</strong></label>
            ...
            <div class="col-lg-4" id="terceroFisicaTraNombre" style="display: none;">
                <div class="form-group">
                    <label class="control-label" style="line-height : 15px;"><strong>Nombre del representante / representado:</strong></label>
                    <input type="text" name="representacion_nombreF" id="representacion_nombreF" class="form-control" placeholder="p. ej. Juan Pérez." pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}" title="Ingresa nombre" value="" required="">
                </div>
            </div>
            ...
            <div class="col-lg-4" id="terceroFisicaTraRFC" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="ProcessNum"><strong>RFC:</strong></label>
                    <input type="text" name="representacion_RfcF" id="representacion_RfcF" class="form-control" placeholder="p. ej. XXXX010101" maxlength="13" pattern="([A-Z]{4}[0-9]{6}[A-Z0-9]{3})" title="Ingresa RFC a 13 dígitos" value="" required="">
                </div>
            </div>
            ...
            <div class="col-lg-4" id="terceroMoralTraDeno" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="NumDoc" style="line-height : 13px;"><strong>Razón social del representante/representado:</strong></label>
                    <input type="text" name="representacion_nombreM" id="representacion_nombreM" class="form-control" placeholder="p. ej. Desarrollo y Redes S.A. de C.V." pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}" title="Ingresa nombre" value="" required="">
                </div>
            </div>
            ...
            <div class="col-lg-4" id="terceroMoralTraRFC" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="ProcessNum"><strong>RFC:<</strong></label>
                    <input type="text" name="representacion_RfcM" id="representacion_RfcM" class="form-control" placeholder="p. ej. XXX010101" maxlength="12" pattern="([A-Z]{3}[0-9]{9})" title="Ingresa RFC a 12 dígitos" value="" required="">
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label" style="line-height : 15px;"><strong>¿Recibe remuneración por su participación?</strong></label>
                    <select id="representacion_recibe_rem" name="representacion_recibe_rem" class="form-control" required="" onchange="mostrarMonto();">
            ...
            <div class="col-lg-4" id="montoMostrar" style="display: none;">
                <div class="form-group">
                    <label class="control-label" for="NumDoc"><strong>Monto mensual neto:</strong></label>
                    <input class="form-control" id="representacion_monto" name="representacion_monto" type="int" pattern="^[0-9]+$" placeholder="p. ej. $1,000,000.00 Mxn" value="" required="">
                </div>
            </div>

            <div class="col-lg-4">
                <div class="form-group">
                    <label class="control-label"><strong>Sector productivo al que pertenece:</strong></label>
                    <select name="dsp_D_sector" id="dsp_D_sector" class="form-control" required="" onchange="MostrarOtro();"><option value="">Seleccione una opción</option><option value="AGRI">AGRICULTURA</option><option value="MIN">MINERÍA</option><option value="EELECT">ENERGÍA ELÉCTRICA</option><option value="CONS">CONSTRUCCIÓN</option><option value="INDMANU">INDUSTRIA MANUFACTURERA</option><option value="CMAYOR">COMERCIO AL POR MAYOR</option><option value="CMENOR">COMERCIO AL POR MENOR</option><option value="TRANS">TRANSPORTE</option><option value="MEDIOM">MEDIOS MASIVOS</option><option value="SERVFIN">SERVICIOS FINANCIEROS</option><option value="SERVINM">SERVICIOS INMOBILIARIOS</option><option value="SERVPROF">SERVICIOS PROFESIONALES</option><option value="SERVCORP">SERVICIOS CORPORATIVOS</option><option value="SERVS">SERVICIOS DE SALUD</option><option value="SERVESPAR">SERVICIOS DE ESPARCIMIENTO</option><option value="SERVALOJ">SERVICIOS DE ALOJAMIENTO</option><option value="OTRO">OTRO (ESPECIFIQUE)</option></select>                                            </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4" id="otro" style="display: none;">
                <div class="form-group">
                    <label class="control-label" style="text-align:justify"><strong>Especifique:</strong></label>
                    <input type="text" name="otro" id="otro" class="form-control" placeholder="p. ej. Sector petrolero" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}" title="Ingresa otro" value="">
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <div id="dom_mex" style="display: none;">
                        <label class="control-label" for="ProcessNum"><strong>Entidad federativa:</strong></label>
                        <input class="form-control" id="representacion_entidad" name="representacion_entidad" type="text" placeholder="p. ej. México" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,50}" value="" required="">
                    </div>
                    <!-- EX  --> 
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <textarea style="background-color:#E8CECF" class="form-control" name="representacion_acla" id="representacion_acla"></textarea>
                </div>
            </div>
        </div>
    </div>
